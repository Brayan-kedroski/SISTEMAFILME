...
import { Film, CheckCircle, Heart, Globe } from 'lucide-react';
...
const Layout = ({ children }) => {
    ...
    return (
        <div className="min-h-screen bg-slate-900 text-white font-sans selection:bg-pink-500 selection:text-white">
            <nav className="fixed bottom-0 left-0 right-0 bg-slate-800/90 backdrop-blur-md border-t border-slate-700 p-4 md:top-0 md:bottom-auto md:border-b md:border-t-0 z-50">
                <div className="max-w-4xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">
                    <div className="flex items-center justify-between w-full md:w-auto">
                        <div className="flex items-center gap-2 text-2xl font-bold bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">
                    ...
                    <div className="hidden md:flex items-center gap-2 bg-slate-800 rounded-full p-1 border border-slate-700">
            ...
            <main className="pb-32 pt-8 md:pt-24 px-4 max-w-4xl mx-auto">
                {children}
            </main>
        </div>
    );
